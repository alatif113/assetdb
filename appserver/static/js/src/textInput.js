                ...
                <div id="${id}" class="control-group shared-controls-controlgroup control-group-default">
                    ...
                    <div role="group" class="controls controls-join">
                        <div class="control shared-controls-textcontrol control-default">
                            ${(data.editable || data.editable == undefined) ? `<input type="text" name="${id}" aria-label="Input" class="" value="${data.value}" autocomplete="off">` : `<span class="uneditable-input" data-role="uneditable-input">${data.value}</span>`}
                        </div>
                    </div>
                </div>`
            );
