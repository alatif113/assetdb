    ...
    class RadioInput {
        ...
        constructor(data) {
            ...
            data.choices.forEach((choice) => {
                ...
                let $button = $(`<button type="button" role="button" name="inputRadioToggle" aria-label="${label}" class="btn ${(choice.value == data.value) ? 'active' : ''}" data-value="${value}" aria-pressed="false">${label}</button>`);
